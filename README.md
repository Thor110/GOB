...
Currently it contains a simple image generator, audio generator, book generator and 3D model generator.
...
For the most part it was able to provide many interesting snippets that helped shape the code but a lot of the time it would write code that doubled up on itself.
